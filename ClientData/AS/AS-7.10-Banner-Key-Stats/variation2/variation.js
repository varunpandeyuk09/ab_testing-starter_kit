/*
 * ============================================================
 * AS 7.10 — Course Page | Banner Key Stats (Variation 2)
 ...
 *  - V2 shows full-length values (no clamp). V1 shows concise 2-line values.
 */
(function () {
  try {
    /* ── Variables ────────────────────────────────────────── */
    var debug = 0;
    var variation_name = "EG-AS-710-V2";
    var BODY_CLASS = "EG-AS-710-V2";
    var MOBILE_BP = 1024;
    var observer = null;
    var isRunning = false;
