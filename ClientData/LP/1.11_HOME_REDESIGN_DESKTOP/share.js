(function () {
  try {
    ...
    function init() {
      live('.eg-card__cta', 'click', function () {
        console.log('EG-LP-1_11: card CTA clicked — ' + this.textContent.trim());
      });
      live('.jw-hero-homepage a', 'click', function () {
        console.log('EG-LP-1_11: hero CTA clicked');
      });
    }
