(function () {
  try {
    ...
    function init() {
      live('.EG-BENEFITS__card', 'click', function () {
        var title = this.querySelector('.EG-BENEFITS__title');
        console.log('EG-ZATTOO-T09: USP card clicked - ' + (title ? title.textContent.trim() : ''));
      });
    }
