(function () {
  try {
    ...
    function init() {
      // Goal 1: User clicks the Back to Top sticky bar
      live('.eg-sticky-bar__btn', 'click', function () {
        console.log('EG-EXAMPLE-SM01: Back to Top clicked');
      });

      // Goal 2: User clicks any product card (engagement signal)
      live('.product-item a', 'click', function () {
        console.log('EG-EXAMPLE-SM01: Product card clicked');
      });
    }
