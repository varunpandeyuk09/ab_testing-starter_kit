...
2. Match the task against the Reusable Patterns Library (playbook §8, P1–P27). Adopt the matching pattern(s) and adapt them. This is the primary source — do NOT run a search unless no pattern fits.
