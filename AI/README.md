...
3. AI/AB_TESTING_PLAYBOOK.md  — coding standards and reusable patterns (P1–P25)
...
The patterns library (playbook §8, P1–P25) is the primary source. If no pattern fits a brief, the AI runs the fallback search against the agency's archive:
